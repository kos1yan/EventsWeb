...
namespace BusinessLogicLayer.Services.Implementations
{
    public class NotificationService : INotificationService
    {
        ...
        public async Task SendMessageAsync(NotificationRequest request, bool trackChanges)
        {
            var eventById = await _repository.Event.GetEventAsync(request.EventId, trackChanges);
